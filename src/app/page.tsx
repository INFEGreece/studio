  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="relative w-full py-12 md:py-32 overflow-hidden bg-secondary/20">
          <div className="container relative z-10 px-4 flex flex-col items-center text-center">
            ...
            <div className="space-y-6 md:space-y-8 max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 md:pt-8 justify-center w-full max-w-md mx-auto sm:max-w-none">
